...
const socialLinks: ISocialLink[] = [
  {
    name: "GitHub",
    url: "https://github.com/AbhishekGuptaOfficial", // Replace with Abhishek's actual GitHub URL
    // iconComponent: FaGithub, // Uncomment and import if using react-icons
  },
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/abhishekgupta-dev/", // Replace with Abhishek's actual LinkedIn URL
    // iconComponent: FaLinkedinIn, // Uncomment and import if using react-icons
  },
  {
    name: "Email",
    url: "mailto:abhishek.gupta.dev@example.com", // Replace with Abhishek's actual email address
